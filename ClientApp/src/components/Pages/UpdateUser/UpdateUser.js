...
export class UpdateUser extends Component {
    ...
    componentDidMount()
    {
        ...
        .then(data => {
          console.log(data);
          const user = data[0];
          this.setState({ ...this.state, isLoading: false, user: user, firstName: user.firstName, lastName: user.lastName, email: user.email, day: user.day, month: user.month, year: user.year });
        });
    }
    ...
    renderPage()
    {
        return(
            ...
            <Form onSubmit={this.updateUser} id="myForm">
                ...
                <Form.Button floated='right' icon labelPosition='left' primary size='big' content='Aanpassen'>
            ...
            <Form onSubmit={this.addAddress} id="myForm">
                ...
                <Form.Button floated='right' icon labelPosition='left' primary size='big' content='Toevoegen'>
