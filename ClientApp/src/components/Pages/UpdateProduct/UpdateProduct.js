  ...
  addPrice = () => {
    ...
    fetch("/api/price/AddPrice", {
      ...
      .then(data => {
        ...
        this.setState({
          ...this.state,
          serverPriceResponse: data.response,
          addPriceError: data.isError,
          priceAdded: data.priceAdded,
          priceFormIsLoading: false
        });
      });
  };
  ...
  updateProduct = () => {
    ...
    fetch("/api/product/updateProduct", {
      ...
      .then(data => {
        this.setState({
          ...this.state,
          serverUpdateProductResponse: data.response,
          updateProductError: data.isError,
