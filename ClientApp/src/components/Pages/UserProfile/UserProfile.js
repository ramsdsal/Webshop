        ...
        <Grid>
            ...
            <Header as='h2' attached='top'>
                ...
                <Segment attached >
                    ...
                    <Menu.Item name='Wachtwoord wijzigen' as={Link} to={PassLink} active={activeItem === 'Wachtwoord wijzigen'} onClick={this.handleItemClick}/>
                ...
                <Form>
                    ...
                    <Form.Group>
                        <Form.Field >
                        <h6>Geboortedatum</h6>
                        <Input type="text" onFocus = {this._onFocus} placeholder={this.state.userBirthDate} readOnly/>
                        </Form.Field>
                    </Form.Group>
                    <Form.Group>
                        <Form.Field >
